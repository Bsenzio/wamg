...
<img src="/NESHomebrews.jpg" width="400" />
...
Although NESMaker produces an autogenerated output files for the ROM, the authors preferred the current repository condition to 

ensure legilibility and verify consistency of the Scientific Contributions stated
